 ...
 */
	public static void main(String[] args) throws IOException {
		...
		for (Integer game : gameIdHash.keySet()){
			...
			if(game > 0)
			{
				...
				String gameID = gameIdHash.get(game);
				...
				if(jsonObj.get("success").getAsBoolean())
				{
					...
					if (jsonObj.get("awayLineUp").getAsJsonArray().size() == 9 && jsonObj.get("homeLineUp").getAsJsonArray().size() == 9){
						// setting line ups
						...
						generateProjectedStats(mcGame.getAwayLineUp(), mcGame, awayTeam, writer);
						...
						generateProjectedStats(mcGame.getHomeLineUp(), mcGame, homeTeam, writer);
						System.out.println("=======================================================================");
						System.out.println(" ");
					} else {
	...
	private static void generateProjectedStats(ArrayList<BattingStats> lineUp, MonteCarloGame mcGame, String team, PrintWriter writer) {
